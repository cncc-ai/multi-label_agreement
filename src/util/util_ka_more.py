"""
copy from https://github.com/pln-fing-udelar/fast-krippendorff  version 0.6.0
    Return more data from alpha method other than alpha only.
...
def alpha_with_dode(reliability_data: npt.ArrayLike | None = None, value_counts: npt.ArrayLike | None = None,
