...
def fleiss_kappa_return_more(table, method='fleiss'):

    """Copy from statsmodels.stats.inter_rater.fleiss_kappa.
    return more data rather than kappa only.
    ...
    # return kappa
    return kappa, p_mean, p_mean_exp
